...
The goal of nhanesGraph is to provide an interactive graphical tools for the users to access more easily. This package utilizes RNHANES, nhanesA, and Shiny packages. 
...
You can install the development version of nhanesGraph from [GitHub](https://github.com/) with:
